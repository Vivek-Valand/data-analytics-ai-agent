{{-- <div class="px-4 pb-24 pt-4 md:p-10 bg-transparent flex justify-center w-full">
    <div class="max-w-3xl w-full shadow-2xl rounded-3xl overflow-hidden glass-input pointer-events-auto">
        <form id="analytics-form" class="flex items-end gap-2 p-3">
            <div class="flex flex-col flex-1">
                <select id="db-selector"
                    class="bg-transparent border-none text-xs text-gray-500 focus:outline-none focus:ring-0 px-3 pt-1">
                ...
                <textarea id="message-input"
                    ...
                    placeholder="Enter an analysis prompt..." rows="1"></textarea>
            </div>
