    ...
    <div class="max-w-3xl w-full shadow-2xl rounded-3xl overflow-hidden glass-input pointer-events-auto">
        <form id="analytics-form" class="flex items-center gap-2 p-3">
            ...
            <button type="submit" id="send-btn" disabled
                class="p-3 bg-indigo-600 hover:bg-indigo-700 text-white rounded-2xl transition-all shadow-md active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed">
